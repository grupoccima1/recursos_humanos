            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <?php
                                $sel="SELECT curp,rfc,cuenta_hsbc,infonavit,fonacot FROM datos_fiscales";
                                ...
                                while($mos=mysqli_fetch_row($res)){?>
                                        ...
                                        <?php echo "<a href='datos_fiscales.php?id=".$mos[0]."'>Modificar</a>";  ?>
                                        </button>
                                        </td>
                                        </td>
                                        <td>
